...
type CalculatorClient interface {
	Calculate(ctx context.Context, in *CalculateMessage, opts ...grpc.CallOption) (*CalculatedMessage, error)
}
...
func (c *calculatorClient) Calculate(ctx context.Context, in *CalculateMessage, opts ...grpc.CallOption) (*CalculatedMessage, error) {
	out := new(CalculatedMessage)
...
type CalculatorServer interface {
	Calculate(context.Context, *CalculateMessage) (*CalculatedMessage, error)
...
func (UnimplementedCalculatorServer) Calculate(context.Context, *CalculateMessage) (*CalculatedMessage, error) {
...
func _Calculator_Calculate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Calculate(ctx, req.(*CalculateMessage))
	}
